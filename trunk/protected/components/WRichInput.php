<?php
/**
 * WRichInput class file.
 * WRichInput is a widget that displays a rich text editor (WYSIWYG / BBCode editor).
 */

class WRichInput extends CInputWidget
{
        public $scriptUrl='/static/js/markitup';
        public $scriptFile;
        public $themeUrl;
        public $theme='simple';
        public $settingsUrl;
        public $settings='bbcode';
        ...
        public function init()
        {
                ...
                if($this->hasModel())
                        echo _CHtml::activeTextArea($this->model,$this->attribute,$this->htmlOptions);
                else
                        echo _CHtml::activeTextArea($name,$this->value,$this->htmlOptions);
        }
