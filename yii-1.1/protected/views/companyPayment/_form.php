...
<div class="w3-form-row">
  <div class="w3-form-row-label"><?php echo _CHtml::activeLabelEx($model,'paymentDate'); ?></div>
  <div class="w3-form-row-input">
    <?php echo _CHtml::activeTextField($model,'paymentDate',array('class'=>'w3-input-text w3-input-w50percents ui-widget-content ui-corner-all'))."\n"; ?>
  </div>
  <div class="clear">&nbsp;</div>
</div>
<div class="w3-form-row">
...
<div class="w3-form-row">
  <div class="w3-form-row-label"><?php echo _CHtml::activeLabelEx($model,'paymentMethod'); ?></div>
  <div class="w3-form-row-input">
    <?php echo _CHtml::activeDropDownList($model,'paymentMethod',$model->getAttributeData('paymentMethod'),array('class'=>'w3-input-text ui-widget-content ui-corner-all'))."\n"; ?>
  </div>
  <div class="clear">&nbsp;</div>
</div>
<div class="w3-form-row">
  <div class="w3-form-row-label"><?php echo _CHtml::activeLabelEx($model,'paymentNumber'); ?></div>
  <div class="w3-form-row-input">
    <?php echo _CHtml::activeTextField($model,'paymentNumber',array('class'=>'w3-input-text ui-widget-content ui-corner-all','maxlength'=>32))."\n"; ?>
  </div>
  <div class="clear">&nbsp;</div>
</div>
<div class="w3-form-row">
...
<div class="w3-form-row">
  ...
  <div class="w3-form-row-input">
    <?php /*echo _CHtml::activeDropDownList($model,'contentMarkup',$model->getAttributeData('contentMarkup'),array('class'=>'w3-input-text w3-input-w50percents ui-widget-content ui-corner-all'));<br/>*/ ?>
...
<?php MClientScript::registerScript('datepicker',array('selector'=>"input[type='text'][name='CompanyPayment[paymentDate]']")); ?>
