...
if (isset($_POST['form_sent']))
{
    ...
    if (!preg_match('#^' . preg_quote(str_replace('www.', '', $pun_config['o_WEB_PATH']) . '/admin_options.php', '#') . '#i', str_replace('www.', '', (isset($_SERVER['HTTP_REFERER']) ? $_SERVER['HTTP_REFERER'] : ''))))
    ...
    while (list($key, $input) = @each($form))
    {
        ...
        if (array_key_exists('o_' . $key, $pun_config) && $pun_config['o_' . $key] != $input)
        {
            ...
            $db->setQuery('UPDATE ' . $db->db_prefix . 'config SET conf_value=' . $value . ' WHERE conf_name=\'o_' . $db->escape($key) . '\'') or error('Unable to update board config', __FILE__, __LINE__, $db->error());
        }
    }
...
?>
	<div class="blockform">
		...
		<div class="box">
			<?php echo CHtml::form(array('admin_options','action'=>'foo'), 'POST');?>
						...
						<div class="infldset">
							<table class="aligntop" cellspacing="0">
								...
								<tr>
									...
									<td>
										<input type="text" name="form[WEB_PATH]" size="50" maxlength="100" value="<?php echo $pun_config['o_WEB_PATH'] ?>" />
							...
							<table class="aligntop" cellspacing="0">
								<tr>
									...
									<td>
										...
										<span>[Current format: <?php echo date($pun_config['o_time_format']) ?>]&nbsp;See <?php echo CHtml::link('here', 'http://www.php.net/manual/en/function.date.php');?> for formatting options.</span>
									</td>
								</tr>
								<tr>
									...
									<td>
										...
										<span>[Current format: <?php echo date($pun_config['o_date_format']) ?>]&nbsp;See <?php echo CHtml::link('here', 'http://www.php.net/manual/en/function.date.php');?> for formatting options.</span>
									</td>
								</tr>
								<tr>
							...
							<table class="aligntop" cellspacing="0">
								...
								<tr>
									...
									<td>
										...
										<span>Enable this to censor specific words in the forum. See <?php echo CHtml::link('Censoring', array('forum/admin_censoring'));?> for more info.</span>
									</td>
								</tr>
								<tr>
								...
								<tr>
									...
									<td>
										...
										<span>Enable this to use user ranks. See <?php echo CHtml::link('Ranks', array('forum/admin_ranks'));?> for more info.</span>
									</td>
								</tr>
								<tr>
