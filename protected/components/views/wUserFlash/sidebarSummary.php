<div class="w3-user-flash-sidebar-summary-wrapper">
<?php foreach($success as $userFlash): ?>
  <div class="w3-sidebar-item<?php echo MLayout::getNumberOfItemsSidebar($in)?'':' w3-first'; ?>">
...
<?php MLayout::incrementNumberOfItemsSidebar($in); ?>
<?php endforeach; ?>
</div><!-- w3-user-flash-sidebar-summary-wrapper -->
