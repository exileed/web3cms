...
(
    ...
    `cssTheme` VARCHAR(64) NOT NULL DEFAULT 'start',
    `accessType` VARCHAR(32) NOT NULL DEFAULT 'member' COMMENT 'member, customer, facilitator, moderator, admin',
...
(
    ...
    `isScreenNameEditable` ENUM('0','1') NOT NULL DEFAULT '1',
...
INSERT INTO User (`id`, `username`, `password`, `email`, `screenName`, `accessType`, `accessLevel`, `isActive`, `createdOn`, `createdGmtOn`) VALUES ('1','admin','21232f297a57a5a743894a0e4a801fc3','admin@example.com','Admin','admin','5','1',NOW(),NOW());
INSERT INTO User (`id`, `username`, `password`, `email`, `screenName`, `accessType`, `accessLevel`, `isActive`, `createdOn`, `createdGmtOn`) VALUES ('2','demo','fe01ce2a7fbac8fafaed7c982a04e229','demo@example.com','Demo','member','1','1',NOW(),NOW());
