...
if (extension_loaded('mbstring'))
{
	if (ini_get('mbstring.func_overload') & MB_OVERLOAD_STRING)
		trigger_error('String functions are overloaded by mbstring', E_USER_ERROR);	mb_internal_encoding('UTF-8');
}// Check whether PCRE has been compiled with UTF-8 support
$UTF8_ar = array();
if (preg_match('/^.{1}$/u', 'ñ', $UTF8_ar) != 1)
	trigger_error('PCRE is not compiled with UTF-8 support', E_USER_ERROR);unset($UTF8_ar);// Load the smartest implementations of utf8_strpos, utf8_strrpos and utf8_substr
if (!defined('UTF8_CORE'))
{
	if (function_exists('mb_substr'))
		require SHELL_PATH.'include/utf8/mbstring/core.php';
	else
	{
		require SHELL_PATH.'include/utf8/utils/unicode.php';
		require SHELL_PATH.'include/utf8/native/core.php';
	}
}// Load the native implementation of utf8_substr_replace
require SHELL_PATH.'include/utf8/substr_replace.php';require SHELL_PATH.'include/utf8/ucwords.php';
require SHELL_PATH.'include/utf8/trim.php';